module Polycon
  module Commands
    ...
    autoload :Templates, 'polycon/commands/templates'
    ...
    register 'templates', aliases: ['t'] do |prefix|
      prefix.register 'create_day', Templates::CreateDay
      prefix.register 'create_week', Templates::CreateWeek
    end
